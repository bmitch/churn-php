...
final class FileFinderTest extends BaseTestCase
{
    ...
    public function it_can_get_the_php_files_in_multiple_directories(): void
    {
        self::assertCount(
            7,
            \iterator_to_array($this->fileFinder->getPhpFiles([__DIR__ . '/../Assets', __DIR__ . '/../Assets2']), false)
        );
    }
    ...
    public function it_can_get_the_php_files_by_name(): void
    {
        self::assertCount(
            2,
            \iterator_to_array(
                $this->fileFinder->getPhpFiles([__DIR__ . '/../Assets/Bar.php', __DIR__ . '/../Assets/Foo.php']),
                false
            )
        );
    }
